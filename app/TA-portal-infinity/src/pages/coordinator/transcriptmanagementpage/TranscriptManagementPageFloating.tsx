...
const TranscriptManagementPageFloating: React.FC<TranscriptManagementPageFloatingProps> = () => {
  const { token } = useAuth();
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">
            Student Transcripts (Floating Preview)
          </h1>
...
export default TranscriptManagementPageFloating;
